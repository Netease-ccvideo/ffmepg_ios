...
source $FF_BUILD_ROOT/../config/module-lite_sdk.sh
...
if [ "$FF_ARCH" = "i386" ]; then
    ...
    FF_BUILD_NAME_MP3LAME=lame-i386
    ...
    FF_BUILD_NAME_MP3LAME=lame-x86_64
    FF_XCRUN_PLATFORM="iPhoneSimulator"
    ...
    FF_BUILD_NAME_MP3LAME=lame-armv7
...
#    FFMPEG_CFG_CPU="--cpu=cortex-a8"
    ...
    FF_BUILD_NAME_MP3LAME=lame-armv7s
    ...
    FF_BUILD_NAME_MP3LAME=lame-arm64
